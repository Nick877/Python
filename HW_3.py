...
if mult_int > comp_item:
    print('The mult_int variable more', comp_item)

div_int = int_item / 2

if div_int < comp_item:
    print('The div_int variable is less', comp_item)

item_1 = 10 + int_item

if item_1 < comp_item:
    print('The item_1 variable is less', comp_item)
else:
    print('The item_1 variable is more or equal to', comp_item)
...
if currency_convertor:
    ...
    ('Variable currency_convertor = ', item_3)